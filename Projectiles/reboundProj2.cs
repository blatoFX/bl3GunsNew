...
{
	public class reboundProj2 : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			projectile.timeLeft = Main.rand.Next(28,38);
		...
		{
			int randY = Main.rand.Next(-5, 5);
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, -projectile.velocity.X, -projectile.velocity.Y + randY, mod.ProjectileType("reboundProj3"), (int)(projectile.damage), 0f, projectile.owner, 0f, 0f);
