...
{
	public class yellowcakeProj1 : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			if (timeLeft == 0)
			{
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X, projectile.velocity.Y + 0.2f, mod.ProjectileType("yellowcakeProj2"), (int)(projectile.damage * 1.5), 0f, projectile.owner, 0f, 0f);
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, projectile.velocity.X, projectile.velocity.Y - 0.2f, mod.ProjectileType("yellowcakeProj2"), (int)(projectile.damage * 1.5), 0f, projectile.owner, 0f, 0f);
			}
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("yellowcakeExplosion"), (int)(projectile.damage * 2), 0f, projectile.owner, 0f, 0f);
		}
	}
}