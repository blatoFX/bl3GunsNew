...
{
	public class roseCorrosiveProj : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("roseCorrosiveExp"), (int)(projectile.damage * 1.2), 0f, projectile.owner, 0f, 0f);
		}
	}
}