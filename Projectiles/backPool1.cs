...
{
	public class backPool1 : ModProjectile
	{
        ...
        public override void Kill(int timeLeft)
        {
			...
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0, 0, mod.ProjectileType("backPool2"), (int)(projectile.damage), 0f, projectile.owner, 0f, 0f);
		}
    }
}