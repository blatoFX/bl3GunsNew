...
{
	public class yellowcakeProj3 : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("yellowcakeExplosion"), (int)(projectile.damage * 3), 0f, projectile.owner, 0f, 0f);
		}
	}
}