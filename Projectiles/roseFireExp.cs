...
{
	internal class roseFireExp : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Dust dust;
				dust = Main.dust[Terraria.Dust.NewDust(projectile.Center, 32, 32, 45, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
			...
			{
				Dust dust2;
				dust2 = Main.dust[Dust.NewDust(projectile.Center, 32, 32, 133, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
				dust2.shader = GameShaders.Armor.GetSecondaryShader(58, Main.LocalPlayer);
				Dust dust;
				dust = Main.dust[Terraria.Dust.NewDust(projectile.Center, 32, 32, 75, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
				dust.shader = GameShaders.Armor.GetSecondaryShader(58, Main.LocalPlayer);
