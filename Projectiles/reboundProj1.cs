...
{
	public class reboundProj1 : ModProjectile
	{
        ...
        {
			int randY = Main.rand.Next(-3,3);
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, -projectile.velocity.X, -projectile.velocity.Y + randY, mod.ProjectileType("reboundProj2"), (int)(projectile.damage), 0f, projectile.owner, 0f, 0f);
