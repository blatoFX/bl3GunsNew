...
namespace bl3guns.Projectiles
{
    internal class flakkerExplosion : ModProjectile
	{
		public override void SetDefaults()
		{
			...
			projectile.timeLeft = Main.rand.Next(5,18);
			drawOffsetX = 5;
			drawOriginOffsetY = 5;
		}
		...
		public override void Kill(int timeLeft)
		{
			if (projectile.ai[1] == 0)
			{
				for (int i = 0; i < 1; i++)
				{
					int newPosX = Main.rand.Next(-100,100);
					int newPosY = Main.rand.Next(-100,100);
					float speedX = 0;
					float speedY = 0;
					Projectile.NewProjectile(projectile.Center.X - newPosX, projectile.Center.Y - newPosY, speedX, speedY, projectile.type, projectile.damage, projectile.knockBack, projectile.owner, 0, 1);
				}
			}
