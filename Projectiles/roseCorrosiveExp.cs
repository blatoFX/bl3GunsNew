...
{
	internal class roseCorrosiveExp : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				Dust dust;
				dust = Main.dust[Terraria.Dust.NewDust(projectile.Center, 18, 18, 45, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
			...
			{
				Dust dust2;
				dust2 = Main.dust[Dust.NewDust(projectile.Center, 18, 18, 133, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
				dust2.shader = GameShaders.Armor.GetSecondaryShader(13, Main.LocalPlayer);
				Dust dust;
				dust = Main.dust[Terraria.Dust.NewDust(projectile.Center, 18, 18, 75, 0f, 0f, 0, new Color(255, 255, 255), 1f)];
				dust.shader = GameShaders.Armor.GetSecondaryShader(13, Main.LocalPlayer);
