...
namespace bl3guns.Items
{
    public class lob : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("[Torgue]\nShoots a slow moving projectile that pierces infinitely\n'Everything has to be magical.'");
        }
		...
		public override void SetDefaults() {
			...
			item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/lob");
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
			...
			Main.PlaySound(mod.GetSoundSlot(SoundType.Item, "Sounds/Item/lob"), (int)player.Center.X, (int)player.Center.Y);
