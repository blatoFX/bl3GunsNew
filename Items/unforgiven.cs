...
namespace bl3guns.Items
{
    public class unforgiven : ModItem
    {
        ...
        {
            DisplayName.SetDefault("Unforgiven");
            Tooltip.SetDefault("[Jakobs]\nHas a 20% chance to fire an additional amped shot, dealing 4x damage\n'It's a helluva thing...'");
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            speedY = perturbedSpeed.Y;
                ...
                {
                    Projectile.NewProjectile(position.X, position.Y, speedX, speedY, mod.ProjectileType("unforgivenProj"), damage * 4, knockBack, player.whoAmI, speedX, speedY);
                }
