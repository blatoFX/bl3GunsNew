...
{
    public class backburner : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Backburner");
            Tooltip.SetDefault("[Vladof]\nFires an orb that leaves behind an elemental pool on death\n'We'll get to it eventually.'");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("backProj");
            item.shootSpeed = 8f;
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            Main.PlaySound(mod.GetSoundSlot(SoundType.Item, "Sounds/Item/yellowcake"), (int)player.Center.X, (int)player.Center.Y);
            type = mod.ProjectileType("backProj");
            return true;
        }
