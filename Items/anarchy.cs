...
namespace bl3guns.Items
{
    public class anarchy : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("[Tediore]\nKills will grant a stacking buff, granting up to +300% damage\n'The stacks... THE STACKS!'");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/anarchy");
            item.autoReuse = false;
            item.shoot = mod.ProjectileType("anarchyProj");
        ...
        {
            Main.PlaySound(mod.GetSoundSlot(SoundType.Item, "Sounds/Item/anarchy"), (int)player.Center.X, (int)player.Center.Y);
            type = mod.ProjectileType("anarchyProj");
