...
{
	public class bloodStarvedBeast : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Blood Starved Beast");
			Tooltip.SetDefault("[Dahl]\nProjectiles penetrate, may cause explosions upon enemy contact\n58% chance not to consuime ammo\n'Chaos, or some say Chaosm.'");
		}
		...
		public override bool Shoot(Terraria.Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			type = mod.ProjectileType("bsbProj");
			return true;
		}
	}
}