...
{
    public class leadSprinkler : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Lead Sprinkler");
            Tooltip.SetDefault("[Jakobs]\nEnemy hits spawn explosive orbs\n'Splish splash.'");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.knockBack = 6;
            item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/lead");
            item.autoReuse = false;
            item.useAmmo = AmmoID.Bullet;
            item.shoot = mod.ProjectileType("leadProj");
            item.shootSpeed = 8f;
            item.noMelee = true;
        }
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            type = mod.ProjectileType("leadProj");
            return true;
        }
