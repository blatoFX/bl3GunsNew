...
namespace bl3Guns.Items
{
    public class sickle : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.UseSound = mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/sickle");
            item.autoReuse = true;
        ...
        {
            type = mod.ProjectileType("sickleProj2");
            Main.PlaySound(mod.GetSoundSlot(SoundType.Item, "Sounds/Item/sickle"), (int)player.Center.X, (int)player.Center.Y);
            return true;
        }
    }
}